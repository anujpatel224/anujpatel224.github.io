window.Modernizr = function(e, t, n) {
    ...
    function c(e, t, n) {
        ...
        return s(t, "string") || s(t, "undefined") ? a(r, t) : (r = (e + " " + k.join(i + " ") + i).split(" "),
        l(r, t, n))
    }
    function u() {
        f.input = function(n) {
        ...
        f.inputtypes = function(e) {
            for (var i, r, s, o = 0, a = e.length; a > o; o++)
                ...
                /^range$/.test(r) && b.style.WebkitAppearance !== n ? (v.appendChild(b),
                s = t.defaultView,
                i = s.getComputedStyle && "textfield" !== s.getComputedStyle(b, null).WebkitAppearance && 0 !== b.offsetHeight,
                v.removeChild(b)) : /^(search|tel)$/.test(r) || (i = /^(url|email)$/.test(r) ? b.checkValidity && b.checkValidity() === !1 : b.value != T)),
                A[e[o]] = !!i;
            return A
        }("search tel url email datetime date month week time datetime-local number range color".split(" "))
    }
    var d, p, h = "2.8.3", f = {}, g = !0, v = t.documentElement, m = "modernizr", y = t.createElement(m), _ = y.style, b = t.createElement("input"), T = ":)", S = {}.toString, x = " -webkit- -moz- -o- -ms- ".split(" "), w = "Webkit Moz O ms", E = w.split(" "), k = w.toLowerCase().split(" "), C = {
        svg: "http://www.w3.org/2000/svg"
    }, j = {}, A = {}, P = {}, L = [], N = L.slice, D = function(e, n, i, r) {
        ...
        if (parseInt(i, 10))
            for (; i--; )
                ...
                a.id = r ? r[i] : m + (i + 1),
                c.appendChild(a);
        return s = ["&#173;", '<style id="s', m, '">', e, "</style>"].join(""),
        c.id = m,
        (u ? c : d).innerHTML += s,
        d.appendChild(c),
        ...
        var i;
        return D("@media " + t + " { #" + m + " { position: absolute; } }", function(t) {
        ...
        function e(e, r) {
            ...
            e = "on" + e;
            var o = e in r;
            return o || (r.setAttribute || (r = t.createElement("div")),
    ...
    p = s(M, "undefined") || s(M.call, "undefined") ? function(e, t) {
    ...
    j.touch = function() {
        var n;
        return "ontouchstart"in e || e.DocumentTouch && t instanceof DocumentTouch ? n = !0 : D(["@media (", x.join("touch-enabled),("), m, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(e) {
            n = 9 === e.offsetTop
        }),
        n
    }
    ...
    j.csstransforms3d = function() {
        var e = !!c("perspective");
        return e && "webkitPerspective"in v.style && D("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}", function(t, n) {
    ...
    j.generatedcontent = function() {
        var e;
        return D(["#", m, "{font:0/0 a}#", m, ':after{content:"', T, '";visibility:hidden;font:3px/1 a}'].join(""), function(t) {
            e = t.offsetHeight >= 3
        }),
        e
    }
    ...
    ,
    j.smil = function() {
        return !!t.createElementNS && /SVGAnimate/.test(S.call(t.createElementNS(C.svg, "animate")))
    }
    ,
    j.svgclippaths = function() {
        return !!t.createElementNS && /SVGClipPath/.test(S.call(t.createElementNS(C.svg, "clipPath")))
    }
    ;
    for (var $ in j)
        p(j, $) && (d = $.toLowerCase(),
    ...
    f.addTest = function(e, t) {
        if ("object" == typeof e)
            ...
            "undefined" != typeof g && g && (v.className += " " + (t ? "" : "no-") + e),
            f[e] = t
        }
        return f
    }
    ...
    function(e, t) {
        ...
        function s(e, n, i) {
            ...
            i || (i = r(n));
            var s;
            return s = i.cache[e] ? i.cache[e].cloneNode() : f.test(e) ? (i.cache[e] = i.createElem(e)).cloneNode() : i.createElem(e),
            !s.canHaveChildren || h.test(e) || s.tagUrn ? s : i.frag.appendChild(s)
        }
        function o(e, n) {
            if (e || (e = t),
            u)
            ...
            n = n || r(e);
            for (var s = n.frag.cloneNode(), o = 0, a = i(), l = a.length; l > o; o++)
                s.createElement(a[o]);
            return s
        }
        function a(e, t) {
        ...
        var c, u, d = "3.7.0", p = e.html5 || {}, h = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, f = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, g = "_html5shiv", v = 0, m = {};
        !function() {
            try {
    ...
    ,
    v.className = v.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (g ? " js " + L.join(" ") : ""),
    f
}(this, this.document),
function(e, t) {
    ...
    function l(e, t, n) {
        ...
        if (void 0 === n && 1 === e.nodeType)
            if (i = "data-" + t.replace(be, "-$1").toLowerCase(),
            n = e.getAttribute(i),
            "string" == typeof n) {
                try {
                    n = "true" === n ? !0 : "false" === n ? !1 : "null" === n ? null : +n + "" === n ? +n : _e.test(n) ? Z.parseJSON(n) : n
                } catch (r) {}
                ye.set(e, t, n)
            } else
                n = void 0;
    ...
    function _(t, n) {
        var i, r = Z(n.createElement(t)).appendTo(n.body), s = e.getDefaultComputedStyle && (i = e.getDefaultComputedStyle(r[0])) ? i.display : Z.css(r[0], "display");
        return r.detach(),
        s
    }
    function b(e) {
        var t = K
          , n = qe[e];
        return n || (n = _(e, t),
        "none" !== n && n || (Ie = (Ie || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement),
    ...
    function T(e, t, n) {
        ...
        n && ("" !== o || Z.contains(e.ownerDocument, e) || (o = Z.style(e, t)),
        Ue.test(o) && Fe.test(t) && (i = a.width,
        r = a.minWidth,
        s = a.maxWidth,
    ...
    function E(e, t, n, i, r) {
        for (var s = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, o = 0; 4 > s; s += 2)
            ...
            i ? ("content" === n && (o -= Z.css(e, "padding" + Se[s], !0, r)),
            "margin" !== n && (o -= Z.css(e, "border" + Se[s] + "Width", !0, r))) : (o += Z.css(e, "padding" + Se[s], !0, r),
            "padding" !== n && (o += Z.css(e, "border" + Se[s] + "Width", !0, r)));
        return o
    }
    function k(e, t, n) {
        var i = !0
    ...
    function C(e, t) {
        for (var n, i, r, s = [], o = 0, a = e.length; a > o; o++)
            i = e[o],
            i.style && (s[o] = me.get(i, "olddisplay"),
            n = i.style.display,
            t ? (s[o] || "none" !== n || (i.style.display = ""),
            "" === i.style.display && xe(i) && (s[o] = me.access(i, "olddisplay", b(i.nodeName)))) : (r = xe(i),
            "none" === n && r || me.set(i, "olddisplay", r ? n : Z.css(i, "display"))));
        for (o = 0; a > o; o++)
            i = e[o],
    ...
    function L(e, t, n) {
        for (var i, r = (nt[t] || []).concat(nt["*"]), s = 0, o = r.length; o > s; s++)
            if (i = r[s].call(n, t, e))
                return i
    }
    function N(e, t, n) {
        var i, r, s, o, a, l, c, u, d = this, p = {}, h = e.style, f = e.nodeType && xe(e), g = me.get(e, "fxshow");
    ...
    function H(e, t, n) {
        var i, r, s = 0, o = tt.length, a = Z.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (r)
                return !1;
            for (var t = Je || A(), n = Math.max(0, c.startTime + c.duration - t), i = n / c.duration || 0, s = 1 - i, o = 0, l = c.tweens.length; l > o; o++)
                c.tweens[o].run(s);
            return a.notifyWith(e, [c, s, n]),
            1 > s && l ? n : (a.resolveWith(e, [c]),
            !1)
        }, c = a.promise({
            elem: e,
            props: Z.extend({}, t),
    ...
    function R(e) {
        return function(t, n) {
            "string" != typeof t && (n = t,
            t = "*");
            var i, r = 0, s = t.toLowerCase().match(he) || [];
            if (Z.isFunction(n))
                for (; i = s[r++]; )
                    "+" === i[0] ? (i = i.slice(1) || "*",
    ...
    function q(e, t, n, i) {
        ...
        if (Z.isArray(t))
            Z.each(t, function(t, r) {
                n || wt.test(e) ? i(e, r) : q(e + "[" + ("object" == typeof r ? t : "") + "]", r, n, i)
            });
        ...
        a--); l > a; a++)
            if (null != (e = arguments[a]))
                for (t in e)
                    n = o[t],
                    i = e[t],
                    o !== i && (c && i && (Z.isPlainObject(i) || (r = Z.isArray(i))) ? (r ? (r = !1,
                    s = n && Z.isArray(n) ? n : []) : s = n && Z.isPlainObject(n) ? n : {},
                    o[t] = Z.extend(c, s, i)) : void 0 !== i && (o[t] = i));
        return o
    }
    ,
    Z.extend({
        ...
        each: function(e, t, i) {
            ...
            if (i) {
                ...
                for (; o > s && (r = t.call(e[s], s, e[s]),
                r !== !1); s++)
                    ;
            else
                for (s in e)
                    if (r = t.call(e[s], s, e[s]),
                    r === !1)
                        break;
            return e
        },
        ...
        proxy: function(e, t) {
            ...
            t = e,
            e = n),
            Z.isFunction(e) ? (i = W.call(arguments, 2),
            r = function() {
    ...
    var re = function(e) {
        function t(e, t, n, i) {
            ...
            if ((t ? t.ownerDocument || t : q) !== N && L(t),
            t = t || N,
            n = n || [],
            a = t.nodeType,
            ...
            if (!i && H) {
                    ...
                    if (o = r[1]) {
                        if (9 === a) {
                            ...
                            if (s.id === o)
                                return n.push(s),
                                n
                        } else if (t.ownerDocument && (s = t.ownerDocument.getElementById(o)) && O(t, s) && s.id === o)
                            return n.push(s),
                            n
                    } else {
                        if (r[2])
                ...
                if (T.qsa && (!R || !R.test(e))) {
                    ...
                    1 === a && "object" !== t.nodeName.toLowerCase()) {
                        ...
                        l = c.length; l--; )
                            c[l] = h + p(c[l]);
                        f = _e.test(e) && u(t.parentNode) || t,
                        g = c.join(",")
                    }
                    if (g)
                        try {
                            return Q.apply(n, f.querySelectorAll(g)),
                            n
                        } catch (v) {} finally {
        ...
        function m(e, t, n, r, s, o) {
            ...
            s && !s[I] && (s = m(s, o)),
            i(function(i, o, a, l) {
                var c, u, d, p = [], h = [], f = o.length, m = i || g(t || "*", a.nodeType ? [a] : a, []), y = !e || !i && t ? m : v(m, p, e, a, l), _ = n ? s || (i ? e : f || r) ? [] : o : y;
                if (n && n(y, _, a, l),
                r)
                    for (c = v(_, h),
                    r(c, [], a, l),
                ...
                if (i) {
                    if (s || e) {
                        ...
                        for (u = _.length; u--; )
                            (d = _[u]) && (c = s ? ee(i, d) : p[u]) > -1 && (i[c] = !(o[c] = d))
                    }
                } else
                    _ = v(_ === o ? _.splice(f, _.length) : _),
                    s ? s(null, o, _, l) : Q.apply(o, _)
            })
        }
        function y(e) {
            for (var t, n, i, r = e.length, s = S.relative[e[0].type], o = s || S.relative[" "], a = s ? 1 : 0, l = h(function(e) {
                return e === t
            }, o, !0), c = h(function(e) {
                return ee(t, e) > -1
            }, o, !0), u = [function(e, n, i) {
                var r = !s && (i || n !== j) || ((t = n).nodeType ? l(e, n, i) : c(e, n, i));
                return t = null,
                r
            }
            ]; r > a; a++)
        ...
        function _(e, n) {
            var r = n.length > 0
              ...
              , o = function(i, o, a, l, c) {
                var u, d, p, h = 0, f = "0", g = i && [], m = [], y = j, _ = i || s && S.find.TAG("*", c), b = F += null == y ? 1 : Math.random() || .1, T = _.length;
        ...
        var b, T, S, x, w, E, k, C, j, A, P, L, N, D, H, R, M, $, O, I = "sizzle" + 1 * new Date, q = e.document, F = 0, U = 0, W = n(), X = n(), z = n(), B = function(e, t) {
            return e === t && (P = !0),
            0
            ...
            for (var n = 0, i = e.length; i > n; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, te = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", ne = "[\\x20\\t\\r\\n\\f]", ie = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", re = ie.replace("w", "w#"), se = "\\[" + ne + "*(" + ie + ")(?:" + ne + "*([*^$|!~]?=)" + ne + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + re + "))|)" + ne + "*\\]", oe = ":(" + ie + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + se + ")*)|.*)\\)|)", ae = new RegExp(ne + "+","g"), le = new RegExp("^" + ne + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ne + "+$","g"), ce = new RegExp("^" + ne + "*," + ne + "*"), ue = new RegExp("^" + ne + "*([>+~]|" + ne + ")" + ne + "*"), de = new RegExp("=" + ne + "*([^\\]'\"]*?)" + ne + "*\\]","g"), pe = new RegExp(oe), he = new RegExp("^" + re + "$"), fe = {
            ID: new RegExp("^#(" + ie + ")"),
            CLASS: new RegExp("^\\.(" + ie + ")"),
        ...
        }, ge = /^(?:input|select|textarea|button)$/i, ve = /^h\d$/i, me = /^[^{]+\{\s*\[native \w/, ye = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, _e = /[+~]/, be = /'|\\/g, Te = new RegExp("\\\\([\\da-f]{1,6}" + ne + "?|(" + ne + ")|.)","ig"), Se = function(e, t, n) {
            var i = "0x" + t - 65536;
        ...
        L = t.setDocument = function(e) {
            ...
            D = i.documentElement,
            n = i.defaultView,
            n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", xe, !1) : n.attachEvent && n.attachEvent("onunload", xe)),
            H = !w(i),
            ...
            M = [],
            R = [],
            (T.qsa = me.test(i.querySelectorAll)) && (r(function(e) {
                D.appendChild(e).innerHTML = "<a id='" + I + "'></a><select id='" + I + "-\f]' msallowcapture=''><option selected=''></option></select>",
            ...
            (T.matchesSelector = me.test($ = D.matches || D.webkitMatchesSelector || D.mozMatchesSelector || D.oMatchesSelector || D.msMatchesSelector)) && r(function(e) {
            ...
            O = t || me.test(D.contains) ? function(e, t) {
            ...
            B = t ? function(e, t) {
                ...
                1 & n || !T.sortDetached && t.compareDocumentPosition(e) === n ? e === i || e.ownerDocument === q && O(q, e) ? -1 : t === i || t.ownerDocument === q && O(q, t) ? 1 : A ? ee(A, e) - ee(A, t) : 0 : 4 & n ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return P = !0,
                    0;
                var n, r = 0, s = e.parentNode, a = t.parentNode, l = [e], c = [t];
                if (!s || !a)
                    return e === i ? -1 : t === i ? 1 : s ? -1 : a ? 1 : A ? ee(A, e) - ee(A, t) : 0;
                if (s === a)
                    return o(e, t);
        ...
        t.attr = function(e, t) {
            ...
            var n = S.attrHandle[t.toLowerCase()]
              , i = n && Y.call(S.attrHandle, t.toLowerCase()) ? n(e, t, !H) : void 0;
            ...
            filter: {
                ...
                ATTR: function(e, n, i) {
                    return function(r) {
                        var s = t.attr(r, e);
                        return null == s ? "!=" === n : n ? (s += "",
                        "=" === n ? s === i : "!=" === n ? s !== i : "^=" === n ? i && 0 === s.indexOf(i) : "*=" === n ? i && s.indexOf(i) > -1 : "$=" === n ? i && s.slice(-i.length) === i : "~=" === n ? (" " + s.replace(ae, " ") + " ").indexOf(i) > -1 : "|=" === n ? s === i || s.slice(0, i.length + 1) === i + "-" : !1) : !0
                    }
                },
                CHILD: function(e, t, n, i, r) {
                    ...
                    : function(t, n, l) {
                        var c, u, d, p, h, f, g = s !== o ? "nextSibling" : "previousSibling", v = t.parentNode, m = a && t.nodeName.toLowerCase(), y = !l && !a;
                        if (v) {
                            if (s) {
                                for (; g; ) {
                                    for (d = t; d = d[g]; )
                            ...
                            o && y) {
                                ...
                                h = c[0] === F && c[1],
                                p = c[0] === F && c[2],
                                d = h && v.childNodes[h]; d = ++h && d && d[g] || (p = h = 0) || f.pop(); )
                                    if (1 === d.nodeType && ++p && d === t) {
                                        u[e] = [F, h, p];
                                        break
                                    }
                            } else if (y && (c = (t[I] || (t[I] = {}))[e]) && c[0] === F)
                                p = c[1];
                            else
                                for (; (d = ++h && d && d[g] || (p = h = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== m : 1 !== d.nodeType) || !++p || (y && ((d[I] || (d[I] = {}))[e] = [F, p]),
                                d !== t)); )
                                    ;
                            return p -= r,
                            p === i || p % i === 0 && p / i >= 0
                ...
                PSEUDO: function(e, n) {
                    var r, s = S.pseudos[e] || S.setFilters[e.toLowerCase()] || t.error("unsupported pseudo: " + e);
                    return s[I] ? s(n) : s.length > 1 ? (r = [e, e, "", n],
        ...
        E = t.tokenize = function(e, n) {
            var i, r, s, o, a, l, c, u = X[e + " "];
            if (u)
                return n ? 0 : u.slice(0);
            for (a = e,
            l = [],
            c = S.preFilter; a; ) {
                (!i || (r = ce.exec(a))) && (r && (a = a.slice(r[0].length) || a),
                l.push(s = [])),
                i = !1,
                ...
                a = a.slice(i.length));
                for (o in S.filter)
                    !(r = fe[o].exec(a)) || c[o] && !(r = c[o](r)) || (i = r.shift(),
                    s.push({
                        value: i,
                        type: o,
                        matches: r
        ...
        C = t.select = function(e, t, n, i) {
            var r, s, o, a, l, c = "function" == typeof e && e, d = !i && E(e = c.selector || e);
            if (n = n || [],
            1 === d.length) {
                if (s = d[0] = d[0].slice(0),
                s.length > 2 && "ID" === (o = s[0]).type && T.getById && 9 === t.nodeType && H && S.relative[s[1].type]) {
                    if (t = (S.find.ID(o.matches[0].replace(Te, Se), t) || [])[0],
                    !t)
                        return n;
                    c && (t = t.parentNode),
                    e = e.slice(s.shift().value.length)
                }
                for (r = fe.needsContext.test(e) ? 0 : s.length; r-- && (o = s[r],
                !S.relative[a = o.type]); )
                    if ((l = S.find[a]) && (i = l(o.matches[0].replace(Te, Se), _e.test(s[0].type) && u(t.parentNode) || t))) {
                        if (s.splice(r, 1),
                        e = i.length && p(s),
                        !e)
                            return Q.apply(n, i),
            ...
            return (c || k(e, d))(i, t, !H, n, _e.test(e) && u(t.parentNode) || t),
            n
        }
        ,
    ...
    var le, ce = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, ue = Z.fn.init = function(e, t) {
        ...
        this.length = 1,
        this) : Z.isFunction(e) ? "undefined" != typeof le.ready ? le.ready(e) : e(Z) : (void 0 !== e.selector && (this.selector = e.selector,
    ...
    Z.fn.extend({
        ...
        closest: function(e, t) {
            for (var n, i = 0, r = this.length, s = [], o = se.test(e) || "string" != typeof e ? Z(e, t || this.context) : 0; r > i; i++)
                for (n = this[i]; n && n !== t; n = n.parentNode)
                    if (n.nodeType < 11 && (o ? o.index(n) > -1 : 1 === n.nodeType && Z.find.matchesSelector(n, e))) {
                        s.push(n);
                        break
                    }
    ...
    Z.Callbacks = function(e) {
        ...
        var t, n, i, r, o, a, l = [], c = !e.once && [], u = function(s) {
            for (t = e.memory && s,
            n = !0,
            a = r || 0,
            r = 0,
    ...
    Z.extend({
                    ...
                    return Z.Deferred(function(n) {
                        Z.each(t, function(t, s) {
                            ...
                            r[s[1]](function() {
                                ...
                                e && Z.isFunction(e.promise) ? e.promise().done(n.resolve).fail(n.reject).progress(n.notify) : n[s[0] + "With"](this === i ? n.promise() : this, o ? [e] : arguments)
                            })
                        }),
                        e = null
                    }).promise()
        ...
        when: function(e) {
            var t, n, i, r = 0, s = W.call(arguments), o = s.length, a = 1 !== o || e && Z.isFunction(e.promise) ? o : 0, l = 1 === a ? e : Z.Deferred(), c = function(e, n, i) {
                return function(r) {
                    n[e] = this,
            ...
            if (o > 1)
                ...
                n = new Array(o),
                i = new Array(o); o > r; r++)
                    s[r] && Z.isFunction(s[r].promise) ? s[r].promise().done(c(r, i, s)).fail(l.reject).progress(c(r, n, t)) : --a;
    ...
    Z.extend({
        ...
        ready: function(e) {
            ...
            e !== !0 && --Z.readyWait > 0 || (ge.resolveWith(K, [Z]),
    ...
    Z.ready.promise = function(t) {
        ...
        "complete" === K.readyState ? setTimeout(Z.ready) : (K.addEventListener("DOMContentLoaded", o, !1),
    ...
    Z.fn.extend({
        data: function(e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (r = ye.get(s),
                1 === s.nodeType && !me.get(s, "hasDataAttrs"))) {
                    for (n = o.length; n--; )
                        o[n] && (i = o[n].name,
    ...
    Z.extend({
        queue: function(e, t, n) {
            ...
            i = me.get(e, t),
            n && (!i || Z.isArray(n) ? i = me.access(e, t, Z.makeArray(n)) : i.push(n)),
            i || []) : void 0
        },
    ...
    Z.fn.extend({
        ...
        promise: function(e, t) {
            var n, i = 1, r = Z.Deferred(), s = this, o = this.length, a = function() {
                --i || r.resolveWith(s, [s])
            };
    ...
    Z.event = {
        ...
        add: function(e, t, n, i, r) {
            var s, o, a, l, c, u, d, p, h, f, g, v = me.get(e);
            if (v)
                for (n.handler && (s = n,
                n = s.handler,
                r = s.selector),
                ...
                c = t.length; c--; )
                    ...
                    (p = l[h]) || (p = l[h] = [],
                    p.delegateCount = 0,
                    d.setup && d.setup.call(e, i, f, o) !== !1 || e.addEventListener && e.addEventListener(h, o, !1)),
        ...
        remove: function(e, t, n, i, r) {
            var s, o, a, l, c, u, d, p, h, f, g, v = me.hasData(e) && me.get(e);
            if (v && (l = v.events)) {
                for (t = (t || "").match(he) || [""],
                c = t.length; c--; )
                    if (a = Ae.exec(t[c]) || [],
                    ...
                    h) {
                        ...
                        o = s = p.length; s--; )
                            u = p[s],
                            !r && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (p.splice(s, 1),
                            u.selector && p.delegateCount--,
                            d.remove && d.remove.call(e, u));
                        o && !p.length && (d.teardown && d.teardown.call(e, f, v.handle) !== !1 || Z.removeEvent(e, h, v.handle),
                        delete l[h])
                    } else
                        for (h in l)
        ...
        trigger: function(t, n, i, r) {
            var s, o, a, l, c, u, d, p = [i || K], h = G.call(t, "type") ? t.type : t, f = G.call(t, "namespace") ? t.namespace.split(".") : [];
            if (o = a = i = i || K,
            3 !== i.nodeType && 8 !== i.nodeType && !je.test(h + Z.event.triggered) && (h.indexOf(".") >= 0 && (f = h.split("."),
            h = f.shift(),
            f.sort()),
            c = h.indexOf(":") < 0 && "on" + h,
            ...
            r || !d.trigger || d.trigger.apply(i, n) !== !1)) {
                if (!r && !d.noBubble && !Z.isWindow(i)) {
                    ...
                    je.test(l + h) || (o = o.parentNode); o; o = o.parentNode)
                        p.push(o),
                        a = o;
                ...
                for (s = 0; (o = p[s++]) && !t.isPropagationStopped(); )
                    ...
                    u && u.apply(o, n),
                    u = c && o[c],
                    u && u.apply && Z.acceptData(o) && (t.result = u.apply(o, n),
                    t.result === !1 && t.preventDefault());
                return t.type = h,
                r || t.isDefaultPrevented() || d._default && d._default.apply(p.pop(), n) !== !1 || !Z.acceptData(i) || c && Z.isFunction(i[h]) && !Z.isWindow(i) && (a = i[c],
                a && (i[c] = null),
                Z.event.triggered = h,
                i[h](),
        ...
        dispatch: function(e) {
            e = Z.event.fix(e);
            var t, n, i, r, s, o = [], a = W.call(arguments), l = (me.get(this, "events") || {})[e.type] || [], c = Z.event.special[e.type] || {};
            if (a[0] = e,
            e.delegateTarget = this,
            !c.preDispatch || c.preDispatch.call(this, e) !== !1) {
                for (o = Z.event.handlers.call(this, e, l),
                t = 0; (r = o[t++]) && !e.isPropagationStopped(); )
                    ...
                    n = 0; (s = r.handlers[n++]) && !e.isImmediatePropagationStopped(); )
                        ...
                        e.data = s.data,
                        i = ((Z.event.special[s.origType] || {}).handle || s.handler).apply(r.elem, a),
                ...
                for (; l !== this; l = l.parentNode || this)
                    if (l.disabled !== !0 || "click" !== e.type) {
                        ...
                        n = 0; a > n; n++)
                            s = t[n],
                            r = s.selector + " ",
                            void 0 === i[r] && (i[r] = s.needsContext ? Z(r, this).index(l) >= 0 : Z.find(r, this, null, [l]).length),
                            i[r] && i.push(s);
                        i.length && o.push({
                            elem: l,
                            handlers: i
        ...
        fix: function(e) {
            ...
            for (o || (this.fixHooks[r] = o = Ce.test(r) ? this.mouseHooks : ke.test(r) ? this.keyHooks : {}),
    ...
    Z.each({
        ...
        Z.event.special[e] = {
            ...
            handle: function(e) {
                ...
                return (!r || r !== i && !Z.contains(i, r)) && (e.type = s.origType,
    ...
    J.focusinBubbles || Z.each({
        ...
        Z.event.special[t] = {
            ...
            teardown: function() {
                var i = this.ownerDocument || this
                  , r = me.access(i, t) - 1;
                r ? me.access(i, t, r) : (i.removeEventListener(e, n, !0),
                me.remove(i, t))
            }
        }
    }),
    ...
    Z.extend({
        clone: function(e, t, n) {
            var i, r, s, o, a = e.cloneNode(!0), l = Z.contains(e.ownerDocument, e);
            ...
            if (t)
                if (n)
                    ...
                    v(e, a);
            return o = m(a, "script"),
            o.length > 0 && g(o, !l && m(e, "script")),
            a
        },
        buildFragment: function(e, t, n, i) {
            for (var r, s, o, a, l, c, u = t.createDocumentFragment(), d = [], p = 0, h = e.length; h > p; p++)
                if (r = e[p],
                r || 0 === r)
                    if ("object" === Z.type(r))
            ...
            for (u.textContent = "",
            p = 0; r = d[p++]; )
                if ((!i || -1 === Z.inArray(r, i)) && (l = Z.contains(r.ownerDocument, r),
        ...
        cleanData: function(e) {
            for (var t, n, i, r, s = Z.event.special, o = 0; void 0 !== (n = e[o]); o++) {
                if (Z.acceptData(n) && (r = n[me.expando],
                r && (t = me.cache[r]))) {
                    if (t.events)
                        for (i in t.events)
    ...
    Z.fn.extend({
        ...
        html: function(e) {
            return ve(this, function(e) {
                ...
                if (void 0 === e && 1 === t.nodeType)
                    return t.innerHTML;
                if ("string" == typeof e && !De.test(e) && !Oe[(Le.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = e.replace(Pe, "<$1></$2>");
                    try {
                        for (; i > n; n++)
                            t = this[n] || {},
        ...
        domManip: function(e, t) {
            e = X.apply([], e);
            var n, i, r, s, o, a, l = 0, c = this.length, u = this, d = c - 1, p = e[0], g = Z.isFunction(p);
            if (g || c > 1 && "string" == typeof p && !J.checkClone && He.test(p))
            ...
            i)) {
                for (r = Z.map(m(n, "script"), h),
                s = r.length; c > l; l++)
                    o = n,
                    l !== d && (o = Z.clone(o, !0, !0),
                    s && Z.merge(r, m(o, "script"))),
                    t.call(this[l], o, l);
                if (s)
                    ...
                    l = 0; s > l; l++)
                        o = r[l],
                        Re.test(o.type || "") && !me.access(o, "globalEval") && Z.contains(a, o) && (o.src ? Z._evalUrl && Z._evalUrl(o.src) : Z.globalEval(o.textContent.replace($e, "")))
            }
            return this
        }
    }),
    ...
    var Ie, qe = {}, Fe = /^margin/, Ue = new RegExp("^(" + Te + ")(?!px)[a-z%]+$","i"), We = function(t) {
    ...
    !function() {
        ...
        var n, i, r = K.documentElement, s = K.createElement("div"), o = K.createElement("div");
        ...
        e.getComputedStyle && Z.extend(J, {
            ...
            reliableMarginRight: function() {
                var t, n = o.appendChild(K.createElement("div"));
    ...
    Z.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, s, o, a = Z.camelCase(t), l = e.style;
                return t = Z.cssProps[a] || (Z.cssProps[a] = x(l, a)),
                o = Z.cssHooks[t] || Z.cssHooks[a],
                void 0 === n ? o && "get"in o && void 0 !== (r = o.get(e, !1, i)) ? r : l[t] : (s = typeof n,
                "string" === s && (r = Be.exec(n)) && (n = (r[1] + 1) * r[2] + parseFloat(Z.css(e, t)),
                s = "number"),
                null != n && n === n && ("number" !== s || Z.cssNumber[a] || (n += "px"),
                J.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"),
                o && "set"in o && void 0 === (n = o.set(e, n, i)) || (l[t] = n)),
                void 0)
            }
        },
        css: function(e, t, n, i) {
            var r, s, o, a = Z.camelCase(t);
            return t = Z.cssProps[a] || (Z.cssProps[a] = x(e.style, a)),
            o = Z.cssHooks[t] || Z.cssHooks[a],
            o && "get"in o && (r = o.get(e, !0, n)),
            void 0 === r && (r = T(e, t, i)),
            "normal" === r && t in Ye && (r = Ye[t]),
            "" === n || n ? (s = parseFloat(r),
            n === !0 || Z.isNumeric(s) ? s || 0 : r) : r
        }
    }),
    Z.each(["height", "width"], function(e, t) {
        Z.cssHooks[t] = {
            ...
            set: function(e, n, i) {
                var r = i && We(e);
                return w(e, n, i ? E(e, t, i, "border-box" === Z.css(e, "boxSizing", !1, r), r) : 0)
            }
        }
    }),
    ...
    Z.fx.step = {};
    var Je, Ke, Qe = /^(?:toggle|show|hide)$/, Ze = new RegExp("^(?:([+-])=|)(" + Te + ")([a-z%]*)$","i"), et = /queueHooks$/, tt = [N], nt = {
        "*": [function(e, t) {
            var n = this.createTween(e, t)
              , i = n.cur()
              , r = Ze.exec(t)
              , s = r && r[3] || (Z.cssNumber[e] ? "" : "px")
              , o = (Z.cssNumber[e] || "px" !== s && +i) && Ze.exec(Z.css(n.elem, e))
              , a = 1
              , l = 20;
            if (o && o[3] !== s) {
                s = s || o[3],
                ...
                do
                    a = a || ".5",
                    o /= a,
                    Z.style(n.elem, e, o + s);
                while (a !== (a = n.cur() / i) && 1 !== a && --l)
            }
            return r && (o = n.start = +o || +i || 0,
            n.unit = s,
    ...
    Z.fn.extend({
        ...
        finish: function(e) {
            return e !== !1 && (e = e || "fx"),
            this.each(function() {
                var t, n = me.get(this), i = n[e + "queue"], r = n[e + "queueHooks"], s = Z.timers, o = i ? i.length : 0;
                for (n.finish = !0,
                Z.queue(this, e, []),
    ...
    var it, rt, st = Z.expr.attrHandle;
    Z.fn.extend({
        attr: function(e, t) {
    ...
    Z.extend({
        attr: function(e, t, n) {
            ...
            if (e && 3 !== s && 8 !== s && 2 !== s)
                return typeof e.getAttribute === Ee ? Z.prop(e, t, n) : (1 === s && Z.isXMLDoc(e) || (t = t.toLowerCase(),
    ...
    Z.fn.extend({
        addClass: function(e) {
            var t, n, i, r, s, o, a = "string" == typeof e && e, l = 0, c = this.length;
            if (Z.isFunction(e))
        ...
        removeClass: function(e) {
            var t, n, i, r, s, o, a = 0 === arguments.length || "string" == typeof e && e, l = 0, c = this.length;
            if (Z.isFunction(e))
                return this.each(function(t) {
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : Z.isFunction(e) ? this.each(function(n) {
                ...
                if ("string" === n)
                    for (var t, i = 0, r = Z(this), s = e.match(he) || []; t = s[i++]; )
                        r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
                else
                    (n === Ee || "boolean" === n) && (this.className && me.set(this, "__className__", this.className),
    ...
    Z.fn.extend({
        val: function(e) {
            var t, n, i, r = this[0];
            {
                ...
                if (r)
                    return t = Z.valHooks[r.type] || Z.valHooks[r.nodeName.toLowerCase()],
            ...
            select: {
                get: function(e) {
                    for (var t, n, i = e.options, r = e.selectedIndex, s = "select-one" === e.type || 0 > r, o = s ? null : [], a = s ? r + 1 : i.length, l = 0 > r ? a : s ? r : 0; a > l; l++)
                        if (n = i[l],
                        (n.selected || l === r) && (J.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !Z.nodeName(n.parentNode, "optgroup"))) {
                            if (t = Z(n).val(),
                            s)
                                return t;
                            o.push(t)
                ...
                set: function(e, t) {
                    for (var n, i, r = e.options, s = Z.makeArray(t), o = r.length; o--; )
                        i = r[o],
    ...
    Z.extend({
        ...
        ajax: function(e, t) {
            function n(e, t, n, o) {
                ...
                n && (y = O(d, T, n)),
                y = I(d, y, T, l),
                l ? (d.ifModified && (b = T.getResponseHeader("Last-Modified"),
            ...
            e = void 0),
            t = t || {};
            var i, r, s, o, a, l, c, u, d = Z.ajaxSetup({}, t), p = d.context || d, h = d.context && (p.nodeType || p.jquery) ? Z(p) : Z.event, f = Z.Deferred(), g = Z.Callbacks("once memory"), v = d.statusCode || {}, m = {}, y = {}, _ = 0, b = "canceled", T = {
                readyState: 0,
            ...
            if (f.promise(T).complete = g.add,
            T.success = T.done,
            T.error = T.fail,
            d.url = ((e || d.url || Tt) + "").replace(dt, "").replace(vt, St[1] + "//"),
            d.type = t.method || t.type || d.method || d.type,
            d.dataTypes = Z.trim(d.dataType || "*").toLowerCase().match(he) || [""],
            null == d.crossDomain && (l = mt.exec(d.url.toLowerCase()),
            d.crossDomain = !(!l || l[1] === St[1] && l[2] === St[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (St[3] || ("http:" === St[1] ? "80" : "443")))),
            ...
            r = d.url,
            d.hasContent || (d.data && (r = d.url += (ut.test(r) ? "&" : "?") + d.data,
            delete d.data),
            d.cache === !1 && (d.url = pt.test(r) ? r.replace(pt, "$1_=" + ct++) : r + (ut.test(r) ? "&" : "?") + "_=" + ct++)),
            d.ifModified && (Z.lastModified[r] && T.setRequestHeader("If-Modified-Since", Z.lastModified[r]),
            ...
            for (u in d.headers)
                T.setRequestHeader(u, d.headers[u]);
    ...
    Z.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !Z(this).is(":disabled") && Ct.test(this.nodeName) && !kt.test(e) && (this.checked || !we.test(e))
            }).map(function(e, t) {
                var n = Z(this).val();
            ...
            send: function(n, i) {
                ...
                t = function(e) {
                    return function() {
                        ...
                        "abort" === e ? s.abort() : "error" === e ? i(s.status, s.statusText) : i(Pt[s.status] || s.status, s.statusText, "string" == typeof s.responseText ? {
                            text: s.responseText
    ...
    Z.ajaxPrefilter("json jsonp", function(t, n, i) {
        var r, s, o, a = t.jsonp !== !1 && (Dt.test(t.url) ? "url" : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && Dt.test(t.data) && "data");
        return a || "jsonp" === t.dataTypes[0] ? (r = t.jsonpCallback = Z.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
        a ? t[a] = t[a].replace(Dt, "$1" + r) : t.jsonp !== !1 && (t.url += (ut.test(t.url) ? "&" : "?") + t.jsonp + "=" + r),
    ...
    Z.offset = {
        setOffset: function(e, t, n) {
            var i, r, s, o, a, l, c, u = Z.css(e, "position"), d = Z(e), p = {};
    ...
    Z.fn.extend({
        offset: function(e) {
            ...
            if (s)
                ...
                Z.contains(t, i) ? (typeof i.getBoundingClientRect !== Ee && (r = i.getBoundingClientRect()),
                n = F(s),
                {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var e = this.offsetParent || Rt; e && !Z.nodeName(e, "html") && "static" === Z.css(e, "position"); )
                    e = e.offsetParent;
                return e || Rt
            })
        }
    ...
    Z.each(["top", "left"], function(e, t) {
        Z.cssHooks[t] = S(J.pixelPosition, function(e, n) {
            return n ? (n = T(e, t),
            Ue.test(n) ? Z(e).position()[t] + "px" : n) : void 0
        })
    }),
    Z.each({
        Height: "height",
        ...
        Z.each({
            ...
            Z.fn[i] = function(i, r) {
                ...
                return ve(this, function(t, n, i) {
                    ...
                    Math.max(t.body["scroll" + e], r["scroll" + e], t.body["offset" + e], r["offset" + e], r["client" + e])) : void 0 === i ? Z.css(t, n, o) : Z.style(t, n, i, o)
                }, t, s ? i : void 0, s, null)
            }
        })
    }),
...
function() {
    ...
    t.addEventListener = function(e, t, n) {
        ...
        var r = i[e];
        return r && this.removeEventListener(e, t, n),
        r = i[e],
        r ? r.push(t) : i[e] = [t],
        t
    }
...
function() {
    ...
    t._createXHR = function(e) {
        ...
        t && i instanceof XMLHttpRequest && 1 == this._xhrLevel && (n.Origin = location.origin),
...
function() {
    ...
    n.SUPPORTED_EXTENSIONS = ["mp3", "ogg", "mpeg", "wav", "m4a", "mp4", "aiff", "wma", "mid"],
    n.EXTENSION_MAP = {
        m4a: "mp4"
    },
    ...
    n._registerSound = function(e) {
        ...
        if (null != r && (isNaN(r.channels) ? isNaN(r) || (s = parseInt(r)) : s = parseInt(r.channels),
        r.audioSprite))
        ...
        return t.create(e.src, s),
        null != r && isNaN(r) ? e.data.channels = s || t.maxPerChannel() : e.data = s || t.maxPerChannel(),
    ...
    n.registerSound = function(e, t, i, r) {
        ...
        if (!o)
            return !1;
        if (n._preloadHash[s.src] || (n._preloadHash[s.src] = []),
        ...
        else if (1 == n._preloadHash[s.src][0])
            return !0;
        return s
    }
    ,
    ...
    n.removeSound = function(e, i) {
        ...
        if (null == r)
            return !1;
        e = r.src;
        for (var s in n._idHash)
            n._idHash[s].src == e && delete n._idHash[s];
    ...
    n._parsePath = function(e) {
        ...
        for (var i = t[4], r = t[5], s = n.getCapabilities(), o = 0; !s[r]; )
            if (r = n.alternateExtensions[o++],
            o > n.alternateExtensions.length)
                return null;
        e = e.replace("." + t[5], "." + r);
        var a = {
            name: i,
    ...
    n.createInstance = function(e, i, r) {
        ...
        var s = n._parsePath(e.src)
          , o = null;
        return null != s && null != s.src ? (t.create(s.src),
        null == i && (i = e.startTime),
        o = n.activePlugin.create(s.src, i, r || e.duration)) : o = new createjs.DefaultSoundInstance(e,i,r),
    ...
    n._playInstance = function(e, t, i, r, s, o, a) {
        if (t instanceof Object && (i = t.delay,
        r = t.offset,
        s = t.loop,
        o = t.volume,
        a = t.pan,
    ...
    n._beginPlaying = function(e, n, i, r, s, o) {
        ...
        if (!a) {
            ...
            return l > -1 && this._instances.splice(l, 1),
            !1
        }
        return !0
    }
    ...
    t.create = function(e, n) {
        var i = t.get(e);
        return null == i ? (t.channels[e] = new t(e,n),
        !0) : !1
    }
    ,
    ...
    i._getSlot = function(t) {
        var n, i;
        if (t != e.INTERRUPT_NONE && (i = this._get(0),
        null == i))
            return !0;
...
function() {
    ...
    ,
    t.resume = function() {
        return this._paused ? (this.setPaused(!1),
        !0) : !1
    }
    ,
    t.stop = function() {
    ...
    t.setLoop = function(e) {
        null != this._playbackResource && (0 != this._loop && 0 == e && this._removeLooping(e),
...
function() {
    ...
    t.register = function(e) {
        if (this._audioSources[e.src] = !0,
        this._soundInstances[e.src] = [],
        this._loaders[e.src])
            return this._loaders[e.src];
        var t = new this._loaderClass(e);
        return t.on("complete", createjs.proxy(this._handlePreloadComplete, this)),
    ...
    t.create = function(e, t, n) {
        ...
        return this._soundInstances[e].push(i),
        i
    }
    ,
    t.setVolume = function(e) {
...
function() {
    ...
    t._createAndPlayAudioNode = function(e, t) {
        ...
        i.buffer = this.playbackResource,
        i.connect(this.panNode);
        var r = .001 * this._duration;
        return i.startTime = e + r,
        i.start(i.startTime, t + .001 * this._startTime, r - t),
        i
    }
    ,
    t._pause = function() {
...
function() {
    ...
    n._generateCapabilities = function() {
        if (null == n._capabilities) {
            ...
            for (var t = createjs.Sound.SUPPORTED_EXTENSIONS, i = createjs.Sound.EXTENSION_MAP, r = 0, s = t.length; s > r; r++) {
                var o = t[r]
                  , a = i[o] || o;
                n._capabilities[o] = "no" != e.canPlayType("audio/" + o) && "" != e.canPlayType("audio/" + o) || "no" != e.canPlayType("audio/" + a) && "" != e.canPlayType("audio/" + a)
            }
...
function() {
    ...
    n.get = function(t) {
        var i = n.tags[t];
        return null == i && (i = n.tags[t] = new e(t)),
        i
    }
    ,
    n.remove = function(e) {
        var t = n.tags[e];
        return null == t ? !1 : (t.removeAll(),
        delete n.tags[e],
        !0)
    }
    ,
...
function() {
    ...
    t.register = function(e, t) {
        for (var n = createjs.HTMLAudioTagPool.get(e.src), i = null, r = 0; t > r; r++)
            i = this._createTag(e.src),
            n.add(i);
    ...
    t.create = function(e, t, n) {
        ...
        return i.setPlaybackResource(null),
        i
    }
    ,
    t.toString = function() {
...
function(e) {
    ...
    t = function() {
        function t(t, i) {
            ...
            s && s.length > -1) {
                ...
                for (o in s)
                    s.hasOwnProperty(o) && (a.breakpoints.push(s[o].breakpoint),
            ...
            a.visibilityChange = "mozvisibilitychange") : "undefined" != typeof document.msHidden ? (a.hidden = "msHidden",
            a.visibilityChange = "msvisibilitychange") : "undefined" != typeof document.webkitHidden && (a.hidden = "webkitHidden",
    ...
    t.prototype.checkResponsive = function(t) {
        var n, i, r, s = this, o = s.$slider.width(), a = window.innerWidth || e(window).width();
        if ("window" === s.respondTo ? r = a : "slider" === s.respondTo ? r = o : "min" === s.respondTo && (r = Math.min(a, o)),
        s.originalSettings.responsive && s.originalSettings.responsive.length > -1 && null !== s.originalSettings.responsive) {
            ...
            "unslick" === s.breakpointSettings[i] ? s.unslick() : (s.options = e.extend({}, s.originalSettings, s.breakpointSettings[i]),
            t === !0 && (s.currentSlide = s.options.initialSlide),
            s.refresh())) : (s.activeBreakpoint = i,
            "unslick" === s.breakpointSettings[i] ? s.unslick() : (s.options = e.extend({}, s.originalSettings, s.breakpointSettings[i]),
            t === !0 && (s.currentSlide = s.options.initialSlide),
            s.refresh())) : null !== s.activeBreakpoint && (s.activeBreakpoint = null,
    ...
    t.prototype.changeSlide = function(t, n) {
        var i, r, s, o = this, a = e(t.target);
        switch (a.is("a") && t.preventDefault(),
        s = o.slideCount % o.options.slidesToScroll !== 0,
        i = s ? 0 : (o.slideCount - o.currentSlide) % o.options.slidesToScroll,
        t.data.message) {
        case "previous":
    ...
    t.prototype.getLeft = function(e) {
        ...
        t = r.options.vertical === !1 ? e * r.slideWidth * -1 + r.slideOffset : e * n * -1 + s,
    ...
    t.prototype.getNavigableIndexes = function() {
        ...
        for (t.options.infinite === !1 ? (e = t.slideCount - t.options.slidesToShow + 1,
        t.options.centerMode === !0 && (e = t.slideCount)) : (n = -1 * t.slideCount,
        i = -1 * t.slideCount,
    ...
    t.prototype.getSlideCount = function() {
        ...
        r.options.swipeToSlide === !0 ? (r.$slideTrack.find(".slick-slide").each(function(t, s) {
            return s.offsetLeft - i + e(s).outerWidth() / 2 > -1 * r.swipeLeft ? (n = s,
            !1) : void 0
        }),
    ...
    t.prototype.lazyLoad = function() {
        ...
        var n, i, r, s, o = this;
        o.options.centerMode === !0 ? o.options.infinite === !0 ? (r = o.currentSlide + (o.options.slidesToShow / 2 + 1),
        s = r + o.options.slidesToShow + 2) : (r = Math.max(0, o.currentSlide - (o.options.slidesToShow / 2 + 1)),
        s = 2 + (o.options.slidesToShow / 2 + 1) + o.currentSlide) : (r = o.options.infinite ? o.options.slidesToShow + o.currentSlide : o.currentSlide,
        s = r + o.options.slidesToShow,
        o.options.fade === !0 && (r > 0 && r--,
        s <= o.slideCount && s++)),
    ...
    t.prototype.setSlideClasses = function(e) {
        ...
        s.options.infinite === !0 && (e >= t && e <= s.slideCount - 1 - t ? s.$slides.slice(e - t, e + t + 1).addClass("slick-active").attr("aria-hidden", "false") : (i = s.options.slidesToShow + e,
        ...
        s.$slides.eq(e).addClass("slick-center")) : e >= 0 && e <= s.slideCount - s.options.slidesToShow ? s.$slides.slice(e, e + s.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false") : n.length <= s.options.slidesToShow ? n.addClass("slick-active").attr("aria-hidden", "false") : (r = s.slideCount % s.options.slidesToShow,
        i = s.options.infinite === !0 ? s.options.slidesToShow + e : e,
        s.options.slidesToShow == s.options.slidesToScroll && s.slideCount - e < s.options.slidesToShow ? n.slice(i - (s.options.slidesToShow - r), i + r).addClass("slick-active").attr("aria-hidden", "false") : n.slice(i, i + s.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false")),
    ...
    t.prototype.selectHandler = function(t) {
        ...
        n.$slides.eq(i).addClass("slick-active").attr("aria-hidden", "false"),
        n.options.centerMode === !0 && (n.$slider.find(".slick-slide").removeClass("slick-center"),
        n.$slides.eq(i).addClass("slick-center")),
        void n.asNavFor(i)) : void n.slideHandler(i)
    }
    ,
    t.prototype.slideHandler = function(e, t, n) {
        var i, r, s, o, a = null, l = this;
        return t = t || !1,
        ...
        r = 0 > i ? l.slideCount % l.options.slidesToScroll !== 0 ? l.slideCount - l.slideCount % l.options.slidesToScroll : l.slideCount + i : i >= l.slideCount ? l.slideCount % l.options.slidesToScroll !== 0 ? 0 : i - l.slideCount : i,
        l.animating = !0,
        ...
        l.updateDots(),
        l.updateArrows(),
        l.options.fade === !0 ? (n !== !0 ? l.fadeSlide(r, function() {
            l.postSlide(r)
        }) : l.postSlide(r),
    ...
    t.prototype.swipeDirection = function() {
        ...
        45 >= i && i >= 0 ? r.options.rtl === !1 ? "left" : "right" : 360 >= i && i >= 315 ? r.options.rtl === !1 ? "left" : "right" : i >= 135 && 225 >= i ? r.options.rtl === !1 ? "right" : "left" : "vertical"
    }
    ,
    ...
    t.prototype.swipeMove = function(e) {
        ...
        !o.dragging || s && 1 !== s.length ? !1 : (t = o.getLeft(o.currentSlide),
        o.touchObject.curX = void 0 !== s ? s[0].pageX : e.clientX,
        o.touchObject.curY = void 0 !== s ? s[0].pageY : e.clientY,
        o.touchObject.swipeLength = Math.round(Math.sqrt(Math.pow(o.touchObject.curX - o.touchObject.startX, 2))),
        n = o.swipeDirection(),
        "vertical" !== n ? (void 0 !== e.originalEvent && o.touchObject.swipeLength > 4 && e.preventDefault(),
        r = (o.options.rtl === !1 ? 1 : -1) * (o.touchObject.curX > o.touchObject.startX ? 1 : -1),
        i = o.touchObject.swipeLength,
        o.touchObject.edgeHit = !1,
        o.options.infinite === !1 && (0 === o.currentSlide && "right" === n || o.currentSlide >= o.getDotCount() && "left" === n) && (i = o.touchObject.swipeLength * o.options.edgeFriction,
        o.touchObject.edgeHit = !0),
        o.options.vertical === !1 ? o.swipeLeft = t + i * r : o.swipeLeft = t + i * (o.$list.height() / o.listWidth) * r,
    ...
    ,
    e.fn.slick = function() {
        var e, n = this, i = arguments[0], r = Array.prototype.slice.call(arguments, 1), s = n.length, o = 0;
        for (o; s > o; o++)
            if ("object" == typeof i || "undefined" == typeof i ? n[o].slick = new t(n[o],i) : e = n[o].slick[i].apply(n[o].slick, r),
            "undefined" != typeof e)
                return e;
        return n
    }
